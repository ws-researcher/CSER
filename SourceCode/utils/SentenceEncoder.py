...
class SentenceEncoder():
    def __init__(self, roberta_type) -> None:
        ...
        if os.path.exists("./pretrained_models/{}".format(roberta_type)):
            encoder = AutoModel.from_pretrained("./pretrained_models/{}".format(roberta_type), output_hidden_states=True)
        else:
